...
<div class="mb-6">
    ...
    <p class="text-gray-400 text-sm mt-1">Welcome back, {{ auth()->user()->name }}! Here are your assigned tickets.</p>
</div>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr>
                    <td colspan="5" class="px-6 py-12 text-center">
                        ...
                        <p class="text-gray-500 font-medium">No tickets assigned to you</p>
                        <p class="text-sm text-gray-400 mt-1">Contact your admin to get assigned</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
