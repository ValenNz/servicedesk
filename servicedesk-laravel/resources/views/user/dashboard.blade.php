...
<div class="mb-6">
    ...
    <p class="text-gray-400 text-sm mt-1">Welcome back, {{ auth()->user()->name }}! Track your submitted tickets.</p>
</div>
        ...
        <table class="w-full">
            <thead>
                <tr class="bg-gray-50">
                    ...
                    <th class="text-left px-6 py-3 text-xs font-semibold text-gray-500 uppercase">Created At</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-gray-100">
                ...
                <tr>
                    <td colspan="5" class="px-6 py-12 text-center">
                        ...
                        <p class="text-gray-500 font-medium">You haven't created any tickets yet</p>
                        <p class="text-sm text-gray-400 mt-1">
                            <a href="{{ route('tickets.create') }}" class="text-red-600 hover:text-red-700">Create your first ticket</a>
                        </p>
                    </td>
                </tr>
                @endforelse
