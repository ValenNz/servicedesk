    ...
    <div class="flex items-center justify-between gap-4">
      <div class="flex items-center gap-4 flex-1">
        ...
        <div class="relative flex-1 max-w-md">
          ...
          <input
            type="text"
            placeholder="Search ticket, category, or keyword..."
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex items-center gap-2 pl-3 border-l border-gray-200">
          <div class="w-9 h-9 bg-red-600 rounded-full flex items-center justify-center text-white text-sm font-semibold shadow-sm">
            {{ adminStore.currentUser.avatar }}
          </div>
          <div class="hidden sm:block">
            <p class="text-sm font-semibold text-gray-800">{{ adminStore.currentUser.name }}</p>
...
const notifications = ref([
  {
    id: 1,
    type: 'ticket',
    message: 'New high priority ticket <b>TKT-008</b> has been created',
    time: '2 minutes ago',
    read: false,
    link: '/tickets/TKT-008'
  },
  {
    id: 2,
    type: 'assign',
    message: 'Ticket <b>TKT-005</b> has been assigned to you',
    time: '15 minutes ago',
    read: false,
    link: '/tickets/TKT-005'
  },
  {
    id: 3,
    type: 'comment',
    message: 'Agent 1 added a comment on <b>TKT-002</b>',
    time: '1 hour ago',
    read: false,
  ...
  },
  {
    id: 4,
    type: 'status',
    message: 'Ticket <b>TKT-003</b> status changed to Resolved',
    time: '3 hours ago',
    read: true,
  ...
  },
  {
    id: 5,
    type: 'user',
    message: 'New user <b>Charlie Davis</b> registered',
    time: '5 hours ago',
    read: true,
    link: '/users'
  },
